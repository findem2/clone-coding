...
function NavbarFix() {
  return (
    <div className="z-50 flex min-h-14 justify-between py-2  sticky top-0 bg-white w-full sm:px-5 md:px-10 xl:px-12 custom:flex">
      ...
      <div className="flex justify-between items-center cursor-pointer">
        <div className="min-w-8 cursor-pointer hidden md:inline pr-2">
          <svg
            role="presentation"
            focusable="false"
            width="30"
        ...
        <div className="pr-2">
          <svg
            className="mr-4 min-w-8 cursor-pointer "
            role="presentation"
            focusable="false"
            width="30"
            height="30"
